          ...
          TextButton(
            onPressed: () {
              if (controller.text.trim().isNotEmpty) {
                context.read<ProjectProvider>().addFolder(controller.text.trim());
                Navigator.pop(context);
              }
            },
                ...
                child: Padding(
                  ...
                  child: _isEditingTitle
                      ? TextField(
                          ...
                          onSubmitted: (val) {
                            projectProvider.updateTitle(val.isNotEmpty ? val : 'Untitled Project');
                            setState(() => _isEditingTitle = false);
                          },
                          onTapOutside: (_) {
                            projectProvider.updateTitle(_titleController.text.isNotEmpty ? _titleController.text : 'Untitled Project');
                            setState(() => _isEditingTitle = false);
                          },
                        )
                      : GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: project.imageUrl == null
                          ? Column(
                              ...
                              children: [
                                Icon(Icons.add_a_photo_outlined, size: 40, color: colorScheme.outline),
                                const SizedBox(height: 8),
                                Text('Add Game Concept Art', style: TextStyle(color: colorScheme.outline)),
                              ],
                            )
                          : Stack(
                              children: [
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('Quick capture notes are managed in the first tab')),
                        );
                      },
                    ),
                  ),
                  ...
                  delegate: SliverChildBuilderDelegate(
                    (context, index) {
                      ...
                      return Card(
                        ...
                        color: colorScheme.surfaceContainerLow,
                        child: ListTile(
                          leading: Icon(Icons.folder_open, color: colorScheme.secondary),
                          ...
                          trailing: Row(
                            ...
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () => projectProvider.deleteFolder(folder.id),
                              ),
                            ],
                          ),
